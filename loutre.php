                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body mb-3">
                                            <div class="cta-inner text-center rounded">
                                                <h3>Mickey</h3>
                                                <img src="public/images/Mickey.jpg"
                                                     alt="Cette photo représente la loutre Mickey"
                                                     height="150" width="200" align="center">
                                                <p>Les loutres à joues blanches sont un genre de loutres de la famille
                                                    des
                                                    Mustélidés. Si la
                                                    loutre du Cap ne se rencontre à l'état sauvage qu'en Afrique, la
                                                    loutre
                                                    cendrée, quant à
                                                    elle, n'est présente qu'en Asie. Une espèce disparue a vécu en
                                                    Europe dont
                                                    en France
                                        ...
                                        <div class="card card-body mb-3">
                                            <div class="cta-inner text-center rounded">
                                                ...
                                                <img src="public/images/loutre-joue-blanche.jpg"
                                                     ...
                                                     height="130" width="250" align="center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body mb-3">
                                            <div class="cta-inner text-center rounded">
                                                <h3>Fagy</h3>
                                                <img src="public/images/loutre-geante.jpg"
                                                     alt="Photo représentant une loutre géante" height="160" width="250"
                                                     align="center">
                                                <p>Les loutres ont de longs corps minces et des membres relativement
                                                    courts,
                                                    avec des pattes
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card card-body mb-3">
                                            <div class="cta-inner text-center rounded">
                                                <h3>Victar</h3>
                                                <img src="public/images/Victar.jpg"
                                                     alt="Photo représentant une loutre géante" height="150" width="250"
                                                     align="center">
                                                <p>Les loutres ont de longs corps minces et des membres relativement
                                                    courts,
                                                    avec des pattes
                                        ...
                                        <div class="card card-body mb-3">
                                            <div class="cta-inner text-center rounded">
                                                <div style="align-content: center">
                                                    ...
                                                    <img src="../public/images/la-nouvelle-portée.jpg"
                                                         alt="Photo de la dernière portée" height="150" width="250">
                                                    <p>Et voici Coban Zoran et Eléa</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
