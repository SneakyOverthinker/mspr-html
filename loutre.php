            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                Manuel est une devenu une loutre et oui grosse histoire vous savez le concernant vous
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <img class="card-img-top" src="public/images/blitz.jpg"
                                 alt="Cette photo représente la loutre Manuel">
                            <div class="card-body">
                                <h5 class="card-title">Blitz</h5>
                                Blizt c'est le bout du train que tu veux absolument atteindre pour être tranquille dans
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <img class="card-img-top" src="public/images/léna.jpeg"
                                 alt="Cette photo représente la loutre Manuel">
                            <div class="card-body">
