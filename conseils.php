...
<main id="main">
    <section class="home-jumbotron">
        <form method="post" action="/conseils/recherche">
        </form>
        ...
        <section id="conseils-pratiques">
            ...
            <div id="container">
                <div class="container">
                    <h1> Comment bien s'occuper de votre Loutre</h1>
                    <h2 class="mb-3">Voici tous les conseils pratiques à connaitre</h2>
                    <p>Si vous rencontrez une loutre adulte et vous pensez qu'elle pourrait être gravement blessée ou
                        ...
                        multitude d'infections ou de parasites.
                        <img src="" alt="">
                        <a href="https://youtu.be/Jb392j1BL3U"></a>
                    ...
                    Si au contraire vous voyez un bébé loutre qui ne pourrait jamais survivre seul, vous pouvez le
                    recueillir dans une boîte en carton assez large, le mettre dans une couverture pour le protéger du
                    froid (s'il fait froid) et l'amener vers un centre de rétablissement animalier ou appeler un garde
                    forestier.</p>

                    <h2 class="mb-3">Alimentation</h2>
                    <ol>
                        <li>Fruits</li>
                        <li>Légumes</li>
                        <li>Poisson</li>
                    ...
                    <h2 class="mb-3">Période de reproduction</h2>
